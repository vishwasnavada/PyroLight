/* I would like to thank open source community and websites like hackster.io, instructables and randomnerdtutorials for the resources on ESP32 camera*/ 
...
#define emailRecipient        "recipient@email.com"
...
void setup() {
  ...
  int  i = 0;
  pinMode(4, INPUT);              //Since I do not want to use flash I'm disbling this
  digitalWrite(4, LOW);
  ...
  int onValue = 180; //Set this servo pin angles based on switch requirements
  int offValue = 150; //Set this servo pin angles based on switch requirements
  if (i == 0)
  {
    ledcAnalogWrite(2, onValue);
    i = 1;
  }
  if (i == 1)
  {
    ledcAnalogWrite(2, offValue);
    i = 0;
  }
  ...
  smtpData.setSender("PyroLight", emailSenderAccount);

  //Set Email priority or importance High, Normal, Low or 1 to 5 (1 is highest)
  smtpData.setPriority("Normal");

  //Set the subject
  smtpData.setSubject("Motion Detected - by PyroLight");
  ...
  delay(5000);                                   //wait for 5 seconds to reduce false triggers from SS-430.
